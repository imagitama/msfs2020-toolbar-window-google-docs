class IngamePanelCustomPanel extends TemplateElement {
    ...
    connectedCallback() {
        ...
        applyButton.addEventListener('click', () => {
            var textInput = document.getElementById('GoogleDocSharedUrl');
            
            this.googleDocSharedUrl = textInput.value;

            if (self.iframeElement) {
                self.iframeElement.src = this.googleDocSharedUrl;
            }
        })
